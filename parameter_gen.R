...
############################################
  ...
  # simInputs = data frame with 10 rows. Each row corresponds to a unique Causal Structure and Severity level combination.  
  # paramGen generates the parameters to be used for a unique Age, Causal Structure and Severity level combination (Scenario).
...
## survInfo: survival age, survival probablities, and baseline hazards. Based on census information, mortality charts, and previous simulations. 
...
SInputs = function(A,survAge = survInfo){
  data.frame(Scen = c(1,rep(2,3),rep(3,3),rep(4,3)), #scenMat row
                                   ...
                                   sampSize = 2000, # number of participants at age A
                                   ...
                                   # Education Effects
                                   a0 = .5,        #Effect of education to pathology (U1)
...
## There are four possible Causal Structures, and two groups the Non-Exposed (High Education) and Exposed (Low Education) group
...
S1 = c(0,0,0,0,    # High Education 
       1,0,0,0)    # Low Education
# Causal Structure 2: education, U1 
S2 = c(0,1,0,0,    # High Education 
       1,1,0,0)    # Low Education 
# Causal Structure 3: interaction of education and U1
S3 = c(0,0,0,0,    # High Education
       1,0,0,1)    # Low Education
# Causal Structure 4: education, U2
S4 = c(0,0,1,0,   # High Education
       1,0,1,0)   # Low Education
